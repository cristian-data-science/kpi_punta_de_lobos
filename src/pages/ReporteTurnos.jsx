...
import { Clock, Calendar, Users, CheckCircle2, AlertCircle, Plus, Edit2, Trash2, RefreshCw, X, CalendarDays, DollarSign, BarChart3, TrendingUp, Target } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">📊 Reporte de Turnos</h1>
          <p className="text-gray-600 mt-1">Calendario con estadísticas detalladas - {formatWeekRange(currentWeekStart)}</p>
        </div>
      ...
      {/* Estadísticas básicas de turnos */}
